...
/* YUV422 or RGB565 */
static uint8_t dvp_image[DVP_IMAGE_WIDTH * DVP_IMAGE_HEIGHT * 2] = {0};
...
int32_t test_jpeg_dvp_start(Jpeg_CodecCfg *enc_cfg)
{
    int32_t ret = FAILURE;
...
static void gc0328_init(uint8_t colorbar_enable)
{
    ...
    csk_i2c_write_reg8(i2c_index, 0x21, 0x52, 0x78);
    csk_i2c_write_reg8(i2c_index, 0x21, 0x53, 0x0);
    csk_i2c_write_reg8(i2c_index, 0x21, 0x54, 0xa0);
    csk_i2c_write_reg8(i2c_index, 0x21, 0x55, 0x0);
    csk_i2c_write_reg8(i2c_index, 0x21, 0x56, 0xf0);
    csk_i2c_write_reg8(i2c_index, 0x21, 0x57, 0x1);
