...
int32_t LUNA_API_SIM(luna_swish_i32o32)(const int32_t *src, int32_t *dst, uint32_t size);
int32_t LUNA_API_SIM(luna_gelu_i32o32)(const int32_t *src, int32_t *dst, uint32_t size);
...
int32_t LUNA_API_SIM(luna_sigmoid_i32o16)(const int32_t *src, int16_t *dst, uint32_t size);
int32_t LUNA_API_SIM(luna_tanh_i32o16)(const int32_t *src, int16_t *dst, uint32_t size);
int32_t LUNA_API_SIM(luna_swish_i32o16)(const int32_t *src, int16_t *dst, uint32_t size);
int32_t LUNA_API_SIM(luna_gelu_i32o16)(const int32_t *src, int16_t *dst, uint32_t size);
...
int32_t LUNA_API_SIM(luna_swish_i32o8)(const int32_t *src, int8_t *dst, uint32_t size);
int32_t LUNA_API_SIM(luna_gelu_i32o8)(const int32_t *src, int8_t *dst, uint32_t size);

int32_t LUNA_API_SIM(luna_lut_i8o8)(const int8_t *data, uint8_t *index, int8_t *dst, uint32_t data_size, uint32_t index_size);
int32_t LUNA_API_SIM(luna_lut_i16o16)(const int16_t *data, uint16_t *index, int16_t *dst, uint32_t data_size, uint32_t index_size);
int32_t LUNA_API_SIM(luna_lut_i32o32)(const int32_t *data, uint32_t *index, int32_t *dst, uint32_t data_size, uint32_t index_size);
